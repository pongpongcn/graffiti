...
public class BidClientInitializer extends ChannelInitializer<SocketChannel> {
	...
	public void initChannel(SocketChannel ch) {
		...
		p.addLast(BidClient.globalTrafficShapingHandler);
		...
		p.addLast(BidClient.bidClientHandler);
	}
}
